            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Chúc mọi người giáng sinh vui vẻ bên gia đình và những người yêu thương. Đặc biệt chúc cậu luôn hạnh phúc và luôn nở nụ cười khi gặp nhiều việc mệt mỏi. ",
                        ],
                        typeSpeed: 250,
                        startDelay: 100,
                        backSpeed: 500,
